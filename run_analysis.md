...
RUN ANALYSIS
============
Last updated 2016-08-27 02:39:45 using R version 3.3.0 (2016-05-03).
...
Preliminaries for this Project.
-------------
...
2 - Set path (My path is "E:/JHU/Course 3/Project")
---------------------------------------------------
...
Download the file. **This was already done on** 2016-08-27 02:39:45 **and don't evaluate again.**
...
Unzip the file. **This was already done on** 2016-08-27 02:39:46 **and don't evaluate again.**
...
**See the `README.txt` file in E:/JHU/Course 3/Project for detailed information on the dataset.**
...
Read the data files. `fread` sometime give some trouble to read the files. Then, Using a helper function, read the file with `read.table` instead, then convert the resulting data frame to a data table. Return the data table.
...
5 - Merge the training and the test sets
------------------------------------
...
6 - Extract only the mean and standard deviation
--------------------------------------------
...
8 - Label with descriptive activity names
-----------------------------------------------------------------
